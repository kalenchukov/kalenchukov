Разработчик с более чем десятилетним опытом программирования на PHP и трёхлетним на Java. Меня всегда привлекал Интернет и разработка Web-сервисов. За свою долгую преданность Web-программированию накопил значительный опыт в сфере разработки Web-приложений. Когда я не пишу программный код, обычно читаю о том, как писать программный код. Ниже перечислил технологии, с которыми работал или работаю по сей день.
