Разработчик с более чем десятилетним опытом программирования на PHP и трёхлетним на Java. Меня всегда привлекал Интернет и разработка Web-сервисов. За свою долгую преданность Web-программированию накопил значительный опыт в данной сфере.
